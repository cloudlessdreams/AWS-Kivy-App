...
class SigninScreen(Screen, Widget):
    ...
    def validate_user(self, username, pin,):
        ...
        try:
            u = Cognito('eu-west-1_APQpK6Ago', '5tiirhr9j46cqnu08bt636ccop', user_pool_region='eu-west-1', username=username, access_key='AKIAIKXWJLXMZF4PMNCA',
                    secret_key='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')
...
class Sigscreen(Screen):
    def savevar(self):
        ...
        idenid = 'eu-west-1:596010b1-f236-4a9d-a232-4377a12aa015'
        ...
        responseRole = client.assume_role_with_web_identity(
            RoleArn='arn:aws:iam::328778611098:role/Cognito_angliaappUnauth_Role',
        ...
        conn = pymysql.connect(host='drivercheckdb.cicq80uvk6jt.eu-west-1.rds.amazonaws.com',
                               port=3306,
                               user=usr,
                               passwd=pssw,
                               db='Driverchecks')
